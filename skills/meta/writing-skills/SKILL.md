...
**Skills are written to `${CC_SKILLS_ROOT}` in your `~/.claude/` directory.** You edit skills in your local branch of this repository.
...
**All skills are in the skills repository at `${CC_SKILLS_ROOT}`:**
...
**To read a skill reference:** Use Read tool on `${CC_SKILLS_ROOT}/category/skill-name/SKILL.md`
